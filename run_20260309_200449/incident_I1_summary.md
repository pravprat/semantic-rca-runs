...
gatekeeper-system/gatekeeper-admin → kube-system/replicaset-controller → kubernetes-admin
...
kube-system/replicaset-controller → kubernetes-admin : 12s
