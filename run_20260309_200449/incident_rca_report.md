...
| 3 | C220 | system:serviceaccount:kube-system:replicaset-controller create pods → HTTP 403 (authorization/client errors) | 26.04 | 16 |
...
| 5 | C67 | kubernetes-admin create deployments in namespace my-argo-cd-argocd-applicationset-controller → HTTP 201 (successful operations) | 23.88 | 9 |
...
| Rank | Cluster | Behavior | Score | Errors |
|------|--------|----------|------|------|
| 2 | C117 | system:node:k8s-node-1-perfspec patch events in namespace my-loki-logs-8mj42.173e3c8107533d12 → HTTP 404 (authorization/client errors) | 33.78 | 4 |
...
| 5 | C163 | system:serviceaccount:gatekeeper-system:gatekeeper-admin list assignmetadata → HTTP 404 (authorization/client errors) | 20.43 | 108 |
