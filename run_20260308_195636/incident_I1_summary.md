...
gatekeeper-system/gatekeeper-admin → system:apiserver → system:kube-controller-manager → kube-prometheus-stack/my-kube-prometheus-stack-admission → kubernetes-admin
...
system:apiserver → system:kube-controller-manager : 15s
system:kube-controller-manager → kube-prometheus-stack/my-kube-prometheus-stack-admission : 7s
