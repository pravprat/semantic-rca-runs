...
gatekeeper-system/gatekeeper-admin → system:kube-controller-manager → kube-prometheus-stack/my-kube-prometheus-stack-admission → kubernetes-admin → system:node:k8s-node-1-perfspec

---

## Propagation Delays

gatekeeper-system/gatekeeper-admin → system:kube-controller-manager : 49s
