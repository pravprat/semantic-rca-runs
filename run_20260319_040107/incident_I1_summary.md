...
- authz failure caused repeated 4xx responses
- These authorization failures prevented successful resource access
- This resulted in widespread failures across services: system:kube-scheduler, system:node:k8s-master-perfspec, system:node:k8s-node-1-perfspec, system:node:k8s-node-2-perfspec, system:serviceaccount:kube-system:replicaset-controller
