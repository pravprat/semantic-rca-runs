...
gatekeeper-system/gatekeeper-admin → system:kube-controller-manager → kubernetes-admin → kube-prometheus-stack/my-kube-prometheus-stack-admission

---

## Propagation Delays

gatekeeper-system/gatekeeper-admin → system:kube-controller-manager : 35s
