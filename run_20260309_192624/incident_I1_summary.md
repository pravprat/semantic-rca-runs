...
gatekeeper-system/gatekeeper-admin → system:node:k8s-node-1-perfspec → kubernetes-admin → kube-prometheus-stack/my-kube-prometheus-stack-admission

---

## Propagation Delays

gatekeeper-system/gatekeeper-admin → system:node:k8s-node-1-perfspec : 35s
system:node:k8s-node-1-perfspec → kubernetes-admin : 11s
kubernetes-admin → kube-prometheus-stack/my-kube-prometheus-stack-admission : 10s
kube-prometheus-stack/my-kube-prometheus-stack-admission → kubernetes-admin : 49s
