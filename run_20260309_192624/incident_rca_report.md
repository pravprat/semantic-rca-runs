...
|------|--------|----------|------|------|
| 2 | C31 | system:serviceaccount:kube-prometheus-stack:my-kube-prometheus-stack-operator update secrets in namespace prometheus-my-kube-prometheus-stack-prometheus → HTTP 200 (successful operations) | 29.79 | 222 |
...
| 4 | C19 | kubernetes-admin get daemonsets in namespace my-prometheus-prometheus-node-exporter → HTTP 404 (authorization/client errors) | 25.11 | 114 |
| 5 | C111 | system:node:k8s-node-1-perfspec list configmaps in namespace my-airflow-airflow-config → HTTP 403 (authorization/client errors) | 21.05 | 5 |
...
| 4 | C15 | system:serviceaccount:argo-cd:argocd-application-controller list secrets → HTTP 200 (successful operations) | 26.38 | 23 |
