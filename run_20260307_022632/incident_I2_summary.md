...
gatekeeper-system/gatekeeper-admin → system:apiserver → kubernetes-admin → system:node:k8s-node-1-perfspec

---

## Propagation Delays

gatekeeper-system/gatekeeper-admin → system:apiserver : 107s
system:apiserver → kubernetes-admin : 70s
kubernetes-admin → system:apiserver : 0s
system:apiserver → system:node:k8s-node-1-perfspec : 20s
...
2023-01-27T18:31:06.106557Z — system:apiserver (HTTP 200)
