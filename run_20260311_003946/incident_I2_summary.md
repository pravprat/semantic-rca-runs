...
gatekeeper-system/gatekeeper-admin → kubernetes-admin → system:apiserver → system:node:k8s-node-1-perfspec
...
system:apiserver → kubernetes-admin : 13s
