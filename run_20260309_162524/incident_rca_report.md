...
- error_count: 108
- graph_out_weight: 95.56999999999998
- graph_in_weight: 79.92
...
```mermaid
flowchart TD
C163["C163"] --> C168["unknown cluster"]
C163["C163"] --> C24["unknown cluster"]
C163["C163"] --> C181["unknown cluster"]
C163["C163"] --> C81["unknown cluster"]
C163["C163"] --> C187["unknown cluster"]
```
...
```mermaid
flowchart TD
C0["C0"] --> C163["unknown cluster"]
C0["C0"] --> C162["unknown cluster"]
C0["C0"] --> C27["unknown cluster"]
C0["C0"] --> C168["unknown cluster"]
C0["C0"] --> C24["unknown cluster"]
```
...
| 4 | C27 | system:serviceaccount:kube-system:deployment-controller update deployments in namespace my-argo-cd-argocd-applicationset-controller → HTTP 200 (successful operations) | 26.63 | 11 |
| 5 | C163 | system:serviceaccount:gatekeeper-system:gatekeeper-admin list assignmetadata → HTTP 404 (authorization/client errors) | 25.23 | 108 |
