...
| 3 | C111 | system:node:k8s-node-1-perfspec list configmaps in namespace my-airflow-airflow-config → HTTP 403 (authorization/client errors) | 25.35 | 5 |
...
| 5 | C15 | system:serviceaccount:argo-cd:argocd-application-controller list secrets → HTTP 200 (successful operations) | 19.59 | 23 |
