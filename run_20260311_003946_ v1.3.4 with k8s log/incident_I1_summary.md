...
gatekeeper-system/gatekeeper-admin → system:node:k8s-node-1-perfspec → kubernetes-admin
...
kubernetes-admin → kubernetes-admin : 39s
kubernetes-admin → kubernetes-admin : 20s
...
2023-01-27T18:29:34.361524Z — kubernetes-admin (HTTP 404)
