...
|------|--------|----------|------|------|
| 2 | C19 | kubernetes-admin get daemonsets in namespace my-prometheus-prometheus-node-exporter → HTTP 404 (authorization/client errors) | 28.77 | 114 |
...
| 3 | C15 | system:serviceaccount:argo-cd:argocd-application-controller list secrets → HTTP 200 (successful operations) | 27.18 | 23 |
| 4 | C182 | kubernetes-admin create secrets in namespace my-redis → HTTP 201 (successful operations) | 27.11 | 13 |
| 5 | C188 | kubernetes-admin get rolebindings in namespace my-kubernetes-dashboard → HTTP 404 (authorization/client errors) | 27.08 | 4 |
