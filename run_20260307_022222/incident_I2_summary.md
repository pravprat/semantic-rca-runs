...
gatekeeper-system/gatekeeper-admin → system:kube-controller-manager → system:apiserver → kubernetes-admin → system:node:k8s-node-1-perfspec
...
system:kube-controller-manager → system:apiserver : 57s
