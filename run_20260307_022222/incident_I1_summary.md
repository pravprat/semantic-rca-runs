...
gatekeeper-system/gatekeeper-admin → system:apiserver → system:kube-controller-manager → kubernetes-admin
...
system:kube-controller-manager → kubernetes-admin : 57s
